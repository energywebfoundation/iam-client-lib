...
var PublicResolver_json = require('@ensdomains/resolver/build/contracts/PublicResolver.json');
...
var EnsRegistryFactory = function (_super) {
  tslib.__extends(EnsRegistryFactory, _super);
...
var PublicResolverFactory = function (_super) {
  tslib.__extends(PublicResolverFactory, _super);
  ...
  if (inputName) {
    ...
    for (var i = labels.length - 1; i >= 0; i--) {
      ...
      if (isEncodedLabelhash(labels[i])) {
        ...
        var normalizedLabel = ethEnsNamehash.normalize(labels[i]);
...
function labelhash(unnormalizedLabelOrLabelhash) {
  return isEncodedLabelhash(unnormalizedLabelOrLabelhash) ? "0x" + decodeLabelhash(unnormalizedLabelOrLabelhash) : "0x" + sha3(ethEnsNamehash.normalize(unnormalizedLabelOrLabelhash));
}
...
var IAM = function () {
  function IAM(_a) {
    ...
    this._walletConnectProvider = new WalletConnectProvider__default['default']({
    ...
    this._resolverSetting = {
      ...
      abi: didEthrResolver.abi1056,
      address: didEthrResolver.address1056,
      method: did.Methods.Erc1056
    };
    this._ensRegistryAddress = ensRegistryAddress;
    this._ensResolverAddress = ensResolverAddress;
    this._ipfsStore = new didIpfsStore.DidStore(ipfsUrl);
  }
      ...
      return tslib.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            this._provider = new ethers.providers.Web3Provider(this._walletConnectProvider);
            this.setAddress();
            this.setResolver();
            this.setSigner();
            this.setDid();
  ...
  IAM.prototype.setResolver = function () {
    if (this._resolverSetting) {
      this._resolver = new didEthrResolver.Resolver(this._resolverSetting);
    }
  };

  IAM.prototype.setDid = function () {
    this._did = "did:" + did.Methods.Erc1056 + ":" + this._address;
  };
      ...
      return tslib.__generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            document_1 = new didDocument.DIDDocumentFull(this._did, new didEthrResolver.Operator(this._signer, this._resolverSetting));
  ...
  IAM.prototype.setClaims = function () {
    if (this._signer && this._document) {
      this._userClaims = new claims.ClaimsUser(this._signer, this._document, this._ipfsStore);
      this._issuerClaims = new claims.ClaimsIssuer(this._signer, this._document, this._ipfsStore);
      this._verifierClaims = new claims.ClaimsVerifier(this._signer, this._document, this._ipfsStore);
    }
  };

  IAM.prototype.setJWT = function () {
    if (this._signer) {
      this._jwt = new jwt.JWT(this._signer);
    }
  };
            ...
            return [4, Promise.all(services.map(function (_a) {
              ...
              return tslib.__awaiter(_this, void 0, void 0, function () {
                ...
                var serviceEndpoint = _a.serviceEndpoint,
                    rest = tslib.__rest(_a, ["serviceEndpoint"]);
                ...
                return tslib.__generator(this, function (_c) {
                  switch (_c.label) {
                    ...
                    case 1:
                      ...
                      return [2, tslib.__assign(tslib.__assign({}, rest), claimData)];
                  }
                });
              });
            }))];
      ...
      return tslib.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            ttl = ethers.utils.bigNumberify(0);
            return [4, this._ensRegistry.setSubnodeRecord(namespaceHash, roleHash, this._address, this._ensResolverAddress, ttl, {
              ...
              gasPrice: ethers.utils.hexlify(10e9)
            })];
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            ...
            ensInterface_1 = new ethers.utils.Interface(PublicResolver_json.abi);
            Event_1 = this._ensResolver.filters.TextChanged(null, "metadata", null);
            filter = {
              fromBlock: 0,
              toBlock: "latest",
              address: Event_1.address,
              topics: tslib.__spread(Event_1.topics)
            };
          ...
          case 2:
            ...
            try {
              for (domains_1 = tslib.__values(domains), domains_1_1 = domains_1.next(); !domains_1_1.done; domains_1_1 = domains_1.next()) {
      ...
      return tslib.__generator(this, function (_c) {
        switch (_c.label) {
          ...
          case 1:
            ...
            try {
              for (domains_2 = tslib.__values(domains), domains_2_1 = domains_2.next(); !domains_2_1.done; domains_2_1 = domains_2.next()) {
  ...
  IAM.prototype.enrol = function (data) {
    return tslib.__awaiter(this, void 0, void 0, function () {
      var enrolmentStatus;
      return tslib.__generator(this, function (_a) {
        enrolmentStatus = tslib.__assign({}, data);
...
Object.defineProperty(exports, 'Algorithms', {
  enumerable: true,
  get: function () {
    return didResolverInterface.Algorithms;
  }
});
Object.defineProperty(exports, 'DIDAttribute', {
  enumerable: true,
  get: function () {
    return didResolverInterface.DIDAttribute;
  }
});
Object.defineProperty(exports, 'Encoding', {
  enumerable: true,
  get: function () {
    return didResolverInterface.Encoding;
  }
});
Object.defineProperty(exports, 'PubKeyType', {
  enumerable: true,
  get: function () {
    return didResolverInterface.PubKeyType;
  }
});
exports.EnrolmentFormData = EnrolmentFormData;
exports.IAM = IAM;
