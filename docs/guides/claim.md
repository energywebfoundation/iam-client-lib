...
### 1. Requesting Claims
A claim request is created by the signer and submitted to the Role issuer(s) using the [createClaimRequest](../api/classes/modules_claims_claims_service.ClaimsService.md#createclaimrequest) method. 
...
-   [getClaimsByRequester](../api/classes/modules_claims_claims_service.ClaimsService.md#getclaimsbyrequester)
-   [getClaimsBySubject](../api/classes/modules_claims_claims_service.ClaimsService.md#getclaimsbysubject)
-   [getUserClaims](../api/classes/modules_claims_claims_service.ClaimsService.md#getuserclaims)
-   [issueClaimRequest](../api/classes/modules_claims_claims_service.ClaimsService.md#issueclaimrequest)
-   [issueClaim](../api/classes/modules_claims_claims_service.ClaimsService.md#issueclaim)
-   [rejectClaimRequest](../api/classes/modules_claims_claims_service.ClaimsService.md#rejectclaimrequest)
-   [issuePublicClaim](../api/classes/modules_claims_claims_service.ClaimsService.md#issuepublicclaim)
-   [publishPublicClaim](../api/classes/modules_claims_claims_service.ClaimsService.md#publishpublicclaim)
-   [registerOnChain](../api/classes/modules_claims_claims_service.ClaimsService.md#registeronchain)

For detailed description of the enrolment flow process, see the [Claims Service end-to-end tests](https://github.com/energywebfoundation/iam-client-lib/blob/f9c1a12e888de6ebb4e2589fe49c489bee84af78/e2e/claims.service.e2e.ts). 