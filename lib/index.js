...
var did = require('@ew-did-registry/did');
var didEthrResolver = require('@ew-did-registry/did-ethr-resolver');
var credentialGovernance = require('@energyweb/credential-governance');
var EKC = require('@energyweb/ekc');
var properties = require('@ethersproject/properties');
var utils = require('ethers/lib/utils');
var detectMetamask = require('@metamask/detect-provider');
var WalletConnect = require('@walletconnect/client');
var QRCodeModal = require('@walletconnect/qrcode-modal');
var safeAppsProvider = require('@gnosis.pm/safe-apps-provider');
var cid = require('multiformats/cid');
var keys = require('@ew-did-registry/keys');
var jwt = require('@ew-did-registry/jwt');
var proxyidentity = require('@ew-did-registry/proxyidentity');
var didResolverInterface = require('@ew-did-registry/did-resolver-interface');
var didDocument = require('@ew-did-registry/did-document');
var didIpfsStore = require('@ew-did-registry/did-ipfs-store');
var claims = require('@ew-did-registry/claims');
var tsInterfaceChecker = require('ts-interface-checker');
var credentialsInterface = require('@ew-did-registry/credentials-interface');
...
var onchainClaims = require('@energyweb/onchain-claims');
var vcVerification = require('@energyweb/vc-verification');
var revocation = require('@ew-did-registry/revocation');
var pex = require('@sphereon/pex');
...
})(exports.ERROR_MESSAGES || (exports.ERROR_MESSAGES = {}));
...
const chainConfig = {
    [VOLTA_CHAIN_ID]: {
        chainName: did.Chain.VOLTA,
        chainDisplayName: 'Energy Web Volta Testnet',
        rpcUrl: 'https://volta-rpc.energyweb.org/',
        ensRegistryAddress: credentialGovernance.VOLTA_ENS_REGISTRY_ADDRESS,
        ensResolverV2Address: credentialGovernance.VOLTA_RESOLVER_V2_ADDRESS,
        ensResolverAddress: credentialGovernance.VOLTA_RESOLVER_V1_ADDRESS,
        ensPublicResolverAddress: credentialGovernance.VOLTA_PUBLIC_RESOLVER_ADDRESS,
        domainNotifierAddress: credentialGovernance.VOLTA_DOMAIN_NOTIFER_ADDRESS,
        assetManagerAddress: credentialGovernance.VOLTA_IDENTITY_MANAGER_ADDRESS,
        didRegistryAddress: didEthrResolver.VoltaAddress1056,
        claimManagerAddress: credentialGovernance.VOLTA_CLAIM_MANAGER_ADDRESS,
        ...
        claimsRevocationRegistryAddress: credentialGovernance.VOLTA_CLAIMS_REVOCATION_REG_ADDR,
    },
    [credentialGovernance.EWC_CHAIN_ID]: {
        chainName: did.Chain.EWC,
        chainDisplayName: 'Energy Web Chain',
        rpcUrl: 'https://rpc.energyweb.org/',
        ensRegistryAddress: credentialGovernance.EWC_ENS_REGISTRY_ADDRESS,
        ensResolverV2Address: credentialGovernance.EWC_RESOLVER_V2_ADDRESS,
        ensResolverAddress: credentialGovernance.EWC_RESOLVER_V2_ADDRESS,
        ensPublicResolverAddress: credentialGovernance.EWC_PUBLIC_RESOLVER_ADDRESS,
        domainNotifierAddress: credentialGovernance.EWC_DOMAIN_NOTIFER_ADDRESS,
        assetManagerAddress: credentialGovernance.EWC_IDENTITY_MANAGER_ADDRESS,
        didRegistryAddress: credentialGovernance.EWC_ADDRESS_1056,
        claimManagerAddress: credentialGovernance.EWC_CLAIM_MANAGER_ADDRESS,
        stakingPoolFactoryAddress: '',
        credentialRevocationRegistryAddress: '',
        claimsRevocationRegistryAddress: credentialGovernance.EWC_CLAIMS_REVOCATION_REG_ADDR,
    },
};
...
})(exports.ExecutionEnvironment || (exports.ExecutionEnvironment = {}));
const executionEnvironment = () => isNode() && !isBrowser()
    ? exports.ExecutionEnvironment.NODE
    : exports.ExecutionEnvironment.BROWSER;
...
})(exports.ProviderEvent || (exports.ProviderEvent = {}));
const PUBLIC_KEY = 'PublicKey';
const IS_ETH_SIGNER = 'isEthSigner';

class ENSTypeNotSupportedError extends Error {
    constructor() {
        super(exports.ERROR_MESSAGES.ENS_TYPE_NOT_SUPPORTED);
    }
}
...
class ENSOwnerNotValidAddressError extends Error {
    constructor(providedOwner) {
        super(`Provided owner param: ${providedOwner}. ${exports.ERROR_MESSAGES.ENS_OWNER_NOT_VALID_ADDRESS}`);
    }
}
...
class EkcSigner extends ethers.Signer {
    constructor(ekc) {
        super();
        this.ekc = ekc;
    ...
    static create(proxyUrl) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                throw new Error(exports.ERROR_MESSAGES.ERROR_IN_AZURE_PROVIDER);
            }
        });
    }
    getAddress() {
    ...
    signTransaction(transaction) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const resolvedTx = yield properties.resolveProperties(transaction);
    ...
    _signTypedData() {
        throw new Error(exports.ERROR_MESSAGES.SIGN_TYPED_DATA_NOT_SUPPORTED);
    }
}
...
addSupportedDID(`${did.Methods.Erc1056}:${did.Chain.EWC}`, did.isValidErc1056EWC);
addSupportedDID(`${did.Methods.Erc1056}:${did.Chain.VOLTA}`, did.isValidErc1056VOLTA);
 ...
 */
class ILogger {
    constructor(_logLevel = exports.LogLevel.debug) {
        this._logLevel = _logLevel;
        this.debug = (message) => this.log(message, exports.LogLevel.debug);
        this.info = (message) => this.log(message, exports.LogLevel.info);
        this.warn = (message) => this.log(message, exports.LogLevel.warn);
        this.error = (message) => this.log(message, exports.LogLevel.error);
...
const { arrayify: arrayify$1, keccak256: keccak256$1, recoverPublicKey, getAddress, hashMessage, verifyMessage, } = ethers.utils;
/**
...
class SignerService {
    ...
    init() {
        var e_1, _a;
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (executionEnvironment() === exports.ExecutionEnvironment.BROWSER) {
            ...
            if (this._signer instanceof ethers.providers.JsonRpcSigner) {
                this._account = (yield this._signer.provider.listAccounts())[0];
            }
            else if (this._signer instanceof ethers.Wallet) {
            ...
            try {
                for (var _b = tslib_es6_js.__asyncValues(this._servicesInitializers), _c; _c = yield _b.next(), !_c.done;) {
     ...
     */
    initEventHandlers() {
        const accChangedHandler = () => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            yield this.closeConnection();
            yield this.init();
        });
        if (this._providerType === exports.ProviderType.MetaMask) {
            this.on(exports.ProviderEvent.AccountChanged, accChangedHandler);
            this.on(exports.ProviderEvent.NetworkChanged, accChangedHandler);
        }
        else if (this._providerType === exports.ProviderType.WalletConnect) {
            this.on(exports.ProviderEvent.SessionUpdate, accChangedHandler);
            this.on(exports.ProviderEvent.Disconnected, this.closeConnection);
        }
    }
     ...
     */
    get did() {
        return `did:${did.Methods.Erc1056}:${this.chainName()}:${this._address}`;
    }
    /**
     ...
     */
    get didHex() {
        return `did:${did.Methods.Erc1056}:${`0x${this.chainId.toString(16)}`}:${this._address.toLowerCase()}`;
    }
    /**
    ...
    send({ to, data, value, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const tx = Object.assign({ to, from: this.address, data }, (value && { value: ethers.BigNumber.from(value) }));
    ...
    signMessage(message) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (this._isEthSigner === undefined) {
                throw new Error(exports.ERROR_MESSAGES.IS_ETH_SIGNER_NOT_SET);
            }
            ...
            if (getAddress(this._address) !== getAddress(verifyMessage(message, sig))) {
                throw new Error(exports.ERROR_MESSAGES.NON_ETH_SIGN_SIGNATURE);
            }
            return sig;
        });
    }
    ...
    _calculatePubKeyAndIdentityToken() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const payload = {
                iss: `did:${did.Methods.Erc1056}:${this.chainName()}:${address}`,
                claimData: {
            ...
            if (getAddress(this._address) === utils.computeAddress(keyFromMessage)) {
                this._publicKey = keyFromMessage;
                this._isEthSigner = false;
            }
            else if (getAddress(this._address) === utils.computeAddress(keyFromDigest)) {
...
const { JsonRpcProvider: JsonRpcProvider$1 } = ethers.providers;
const fromPrivateKey = (privateKey, rpcUrl) => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    const provider = new JsonRpcProvider$1({ url: rpcUrl });
    const signerService = new SignerService(new ethers.Wallet(privateKey).connect(provider), exports.ProviderType.PrivateKey);
    yield signerService.init();
    return signerService;
});

const fromMetaMask = () => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const signerService = new SignerService(signer, exports.ProviderType.MetaMask);
    provider.on(exports.ProviderEvent.AccountChanged, () => signerService.emit(exports.ProviderEvent.AccountChanged));
    provider.on(exports.ProviderEvent.NetworkChanged, () => signerService.emit(exports.ProviderEvent.NetworkChanged));
    yield signerService.init();
    return signerService;
});
const createMetamaskProvider = () => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const metamaskProvider = yield detectMetamask({
        mustBeMetaMask: true,
    });
    if (!metamaskProvider) {
        throw new Error(exports.ERROR_MESSAGES.METAMASK_PROVIDER_NOT_DETECTED);
    }
    const requestObject = {
        method: 'eth_accounts',
        params: [
...
const isMetamaskExtensionPresent = () => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
...
const fromWalletConnectMetamask = (bridge, infuraId) => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    const walletProvider = createWalletConnectProvider(bridge, infuraId);
    yield walletProvider.enable();
    const provider = new ethers.providers.Web3Provider(walletProvider);
    const signerService = new SignerService(provider.getSigner(), exports.ProviderType.WalletConnect);
    walletProvider.on(exports.ProviderEvent.Disconnected, () => signerService.emit(exports.ProviderEvent.Disconnected));
    walletProvider.on(exports.ProviderEvent.SessionUpdate, () => signerService.emit(exports.ProviderEvent.SessionUpdate));
    yield signerService.init();
    return signerService;
});
 ...
 */
const fromGnosis = (safeAppSdk) => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    const gnosisProvider = new safeAppsProvider.SafeAppProvider(yield safeAppSdk.safe.getInfo(), safeAppSdk);
    const provider = new ethers.providers.Web3Provider(gnosisProvider);
    const signerService = new SignerService(provider.getSigner(), exports.ProviderType.Gnosis);
    return signerService;
});
...
class StakingPool__factory extends ethers.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
const { namehash: namehash$2, parseUnits } = ethers.utils;
/**
...
class StakingPoolService {
    constructor(signerService, address) {
        ...
        this.overrides = {
            ...
            gasLimit: ethers.BigNumber.from(490000),
        };
    ...
    putStake(stake) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            stake = ethers.BigNumber.from(stake);
            const tx = {
            ...
            if (maxStake.lte(0)) {
                throw new Error(exports.ERROR_MESSAGES.INSUFFICIENT_BALANCE);
            }
    ...
    getStake() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const stakeStatus = staked.gt(0)
                ? exports.StakeStatus.STAKING
                : exports.StakeStatus.NONSTAKING;
            return {
                amount: staked,
                depositStart: start,
                depositEnd: end,
...
const { UpdateServicePoint, UpdateDelegate, UpdatePublicKey } = tsInterfaceChecker.createCheckers({
    UpdateServicePoint: tsInterfaceChecker.iface([], {
        did: IS_REQ_STRING,
        didAttribute: tsInterfaceChecker.enumtype({ ServicePoint: didResolverInterface.DIDAttribute.ServicePoint }),
        data: tsInterfaceChecker.iface([], {
            type: tsInterfaceChecker.enumtype({ ServicePoint: didResolverInterface.DIDAttribute.ServicePoint }),
            value: tsInterfaceChecker.iface([], {
                id: IS_REQ_STRING,
                hash: IS_REQ_STRING,
    ...
    UpdateDelegate: tsInterfaceChecker.iface([], {
        did: IS_REQ_STRING,
        didAttribute: tsInterfaceChecker.enumtype({ Authenticate: didResolverInterface.DIDAttribute.Authenticate }),
        data: tsInterfaceChecker.iface([], {
            type: tsInterfaceChecker.enumtype(didResolverInterface.PubKeyType),
            value: tsInterfaceChecker.iface([], {
                id: IS_REQ_STRING,
                hash: IS_REQ_STRING,
                hashAlg: IS_REQ_STRING,
    ...
    UpdatePublicKey: tsInterfaceChecker.iface([], {
        did: IS_REQ_STRING,
        didAttribute: tsInterfaceChecker.enumtype({ PublicKey: didResolverInterface.DIDAttribute.PublicKey }),
        data: tsInterfaceChecker.iface([], {
            type: tsInterfaceChecker.enumtype(didResolverInterface.PubKeyType),
            algo: tsInterfaceChecker.opt(tsInterfaceChecker.enumtype(keys.KeyType)),
            encoding: tsInterfaceChecker.opt(tsInterfaceChecker.enumtype(didResolverInterface.Encoding)),
            value: tsInterfaceChecker.iface([], {
...
class DidRegistry {
    ...
    init() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            this._ipfsStore = new didIpfsStore.DidStore(this._ipfsConfig);
    ...
    verifyPublicClaim(token, iss) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const verifier = new claims.ProofVerifier(issuerDoc);
    ...
    updateDocument({ didAttribute, data, validity, did = this._signerService.did, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const updateData = Object.assign({ algo: keys.KeyType.Secp256k1, encoding: didResolverInterface.Encoding.HEX }, data);
            const update = yield didDocument.update(didAttribute, updateData, validity);
            return update._hex !== ethers.BigNumber.from(0)._hex;
        });
    }
    /**
     ...
     * @return true if document was updated successfully
     */
    updateSignedDidPublicKey({ did = this._signerService.did, publicKey, validity, algo = keys.KeyType.Secp256k1, type = didResolverInterface.PubKeyType.SignatureAuthentication2018, tag = '', }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (!publicKey)
                throw new Error(exports.ERROR_MESSAGES.CAN_NOT_UPDATE_DOCUMENT_PROPERTIES_INVALID_OR_MISSING +
                    'publicKey');
            const didDocument = yield this.getDIDDocFull(did);
     ...
     * @return true if document was updated successfully
     */
    updateSignedDidDelegate({ did = this._signerService.did, delegatePublicKey, validity, algo = keys.KeyType.Secp256k1, type = didResolverInterface.PubKeyType.SignatureAuthentication2018, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
    ...
    createDocument() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (this._cacheClient) {
                ...
                const pubKey = cachedDoc.publicKey.find((pk) => pk.id.endsWith(didResolverInterface.KeyTags.OWNER));
                if (!pubKey) {
    ...
    getDIDDocFull(did) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (did === this._signerService.did) {
                ...
                if (!assetDID) {
                    throw new Error(exports.ERROR_MESSAGES.CAN_NOT_UPDATE_NOT_CONTROLLED_DOCUMENT);
                }
                const { didRegistryAddress: didContractAddress } = chainConfigs()[this._signerService.chainId];
                const operator = new proxyidentity.ProxyOperator(this._identityOwner, { address: didContractAddress }, didEthrResolver.addressOf(assetDID));
                return new didDocument.DIDDocumentFull(did, operator);
            }
        });
    }
    /**
    ...
    _setOperator() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (signer instanceof ethers.Wallet && provider instanceof JsonRpcProvider) {
                this._identityOwner = didEthrResolver.EwSigner.fromPrivateKey(signer.privateKey, {
                    type: didResolverInterface.ProviderTypes.HTTP,
                    uriOrInfo: provider.connection.url,
                });
            }
            else if (provider instanceof JsonRpcProvider) {
                this._identityOwner = didEthrResolver.EwSigner.fromEthersSigner(signer, publicKey);
            }
            else {
                /** @todo from EIP1193Provider */
                throw new Error(exports.ERROR_MESSAGES.UNKNOWN_PROVIDER);
            }
            this._did = `did:${did.Methods.Erc1056}:${this._signerService.chainName()}:${yield signer.getAddress()}`;
            const address = chainConfigs()[this._signerService.chainId].didRegistryAddress;
            this._operator = new didEthrResolver.Operator(this._identityOwner, { address });
        });
    }
    /**
     * Set JWT
     ...
     */
    setJWT() {
        this._jwt = new jwt.JWT(this._identityOwner);
    }
    /**
     ...
     */
    _setDocument() {
        this._document = new didDocument.DIDDocumentFull(this._did, this._operator);
    }
    /**
     ...
     */
    _setClaims() {
        this._userClaims = new claims.ClaimsUser(this._identityOwner, this._document, this._ipfsStore);
        this._issuerClaims = new claims.ClaimsIssuer(this._identityOwner, this._document, this._ipfsStore);
    }
    /**
    ...
    downloadClaims({ services, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            return Promise.all(services.map((_a) => { var _b; return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
                var { serviceEndpoint } = _a, rest = tslib_es6_js.__rest(_a, ["serviceEndpoint"]);
                ...
                if (/(^[\w-]*\.[\w-]*\.[\w-]*$)/.test(tokenOrVc)) {
                    ...
                    const { claimData } = decodedData, claimRest = tslib_es6_js.__rest(decodedData, ["claimData"]);
                    return Object.assign(Object.assign(Object.assign({ serviceEndpoint }, rest), claimData), claimRest);
                }
                try {
                    const data = JSON.parse(tokenOrVc);
                    if (credentialsInterface.isVerifiableCredential(data)) {
    ...
    validDateUpdateDocumentRequest({ didAttribute, data, did, }) {
        ...
        try {
            switch (didAttribute) {
                case didResolverInterface.DIDAttribute.ServicePoint:
                    UpdateServicePoint.check(rq);
                    break;
                case didResolverInterface.DIDAttribute.Authenticate:
                    UpdateDelegate.check(rq);
                    break;
                case didResolverInterface.DIDAttribute.PublicKey:
...
const isClaimService = (service) => {
    return lodash.has(service, 'claimType') && lodash.has(service, 'claimTypeVersion');
};

exports.MessagingMethod = void 0;
...
const messagingConfig = {
    [VOLTA_CHAIN_ID]: {
        messagingMethod: exports.MessagingMethod.Nats,
...
class MessagingService {
    ...
    init() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (executionEnvironment() === exports.ExecutionEnvironment.NODE) {
                return;
            }
            const { messagingMethod, natsServerUrl, natsEnvironmentName } = getMessagingConfig()[this._signerService.chainId];
            if (natsServerUrl && messagingMethod === exports.MessagingMethod.Nats) {
                this._natsEnvironmentName = natsEnvironmentName;
                this._jsonCodec = nats_ws.JSONCodec();
                try {
                    const timeout = 3000;
...
const defaultConfig = {
    [credentialGovernance.VOLTA_CHAIN_ID]: {
...
class SiweAuthTokensClient {
    ...
    getAuthTokens() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const siweMessage = new siwe.SiweMessage(Object.assign(Object.assign({}, this.config), { nonce }));
...
class AuthService {
    ...
    constructor(signerService, httpClient, { authStatusPath = DEFAULT_AUTH_STATUS_PATH, siweOptions, }) {
        ...
        this.isBrowser = executionEnvironment() === exports.ExecutionEnvironment.BROWSER;
        ...
        axiosRetry(this.httpClient, {
            ...
            retryCondition: (error) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
                try {
...
class CacheClient {
    ...
    getAssetHistory(id, { order, take, skip, type } = {}) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const query = qs.stringify({ order, take, skip, type }, { skipNulls: true });
    ...
    if (inputName) {
        ...
        for (let i = labels.length - 1; i >= 0; i--) {
            ...
            if (isEncodedLabelhash(labels[i])) {
                ...
                const normalizedLabel = ethEnsNamehash.normalize(labels[i]);
...
function labelhash(unnormalizedLabelOrLabelhash) {
    return isEncodedLabelhash(unnormalizedLabelOrLabelhash)
        ...
        : '0x' + sha3(ethEnsNamehash.normalize(unnormalizedLabelOrLabelhash));
}

exports.RegistrationTypes = void 0;
...
})(exports.RegistrationTypes || (exports.RegistrationTypes = {}));
exports.ClaimEventType = void 0;
...
})(exports.ClaimEventType || (exports.ClaimEventType = {}));
...
const erc712_type_hash = ethers.utils.id('EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)');
const agreement_type_hash = ethers.utils.id('Agreement(address subject,bytes32 role,uint256 version)');
const proof_type_hash = ethers.utils.id('Proof(address subject,bytes32 role,uint256 version,uint256 expiry,address issuer)');
...
})(exports.NamespaceType || (exports.NamespaceType = {}));
...
class DomainsService {
    constructor(_signerService, _cacheClient) {
        this._signerService = _signerService;
        this._cacheClient = _cacheClient;
        this._ttl = ethers.BigNumber.from(0);
        this._signerService.onInit(this.init.bind(this));
    }
    ...
    init() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            this._ensRegistry = new ENSRegistry__factory(ENSRegistry__factory.createInterface(), ENSRegistry__factory.bytecode)
                ...
                .connect(provider);
            this._domainDefinitionReader = new credentialGovernance.DomainReader({
                ensRegistryAddress,
                provider,
            });
            this._domainDefinitionReader.addKnownResolver({
                ...
                type: credentialGovernance.ResolverContractType.RoleDefinitionResolver_v2,
            });
            // until role definitions are migrated to resolver_v2
            if (chainId === credentialGovernance.VOLTA_CHAIN_ID) {
                this._domainDefinitionReader.addKnownResolver({
                    chainId,
                    address: ensResolverAddress,
                    type: credentialGovernance.ResolverContractType.RoleDefinitionResolver_v1,
                });
                this._domainDefinitionReader.addKnownResolver({
                    chainId,
                    address: ensPublicResolverAddress,
                    type: credentialGovernance.ResolverContractType.PublicResolver,
                });
            }
            this._domainDefinitionTransactionFactory = new credentialGovernance.DomainTransactionFactoryV2({
                domainResolverAddress: ensResolverV2Address,
            });
            this._domainHierarchy = new credentialGovernance.DomainHierarchy({
    ...
    createOrganization({ orgName, namespace, data, returnSteps, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const rolesDomain = `${exports.NamespaceType.Role}.${orgDomain}`;
            const appsDomain = `${exports.NamespaceType.Application}.${orgDomain}`;
            if (!(yield this.isOwner({ domain: namespace, user: this._owner }))) {
                throw new Error(exports.ERROR_MESSAGES.NOT_AUTHORIZED_TO_CHANGE_DOMAIN);
            }
            const steps = [
                {
                ...
                },
                {
                    tx: this.createSubdomainTx({
                        domain: orgDomain,
                        nodeName: exports.NamespaceType.Role,
                        owner: this._owner,
                    }),
                ...
                },
                {
                    tx: this.createSubdomainTx({
                        domain: orgDomain,
                        nodeName: exports.NamespaceType.Application,
                        owner: this._owner,
                    }),
            ...
            ].map((step) => (Object.assign(Object.assign({}, step), { next: () => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (returnSteps) {
                ...
                try {
                    for (var steps_1 = tslib_es6_js.__asyncValues(steps), steps_1_1; steps_1_1 = yield steps_1.next(), !steps_1_1.done;) {
    ...
    createApplication({ appName, namespace: domain, data, returnSteps, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const steps = [
                ...
                {
                    tx: this._domainDefinitionTransactionFactory.setDomainNameTx({
                        domain: `${exports.NamespaceType.Role}.${appDomain}`,
                    }),
            ...
            try {
                for (var steps_2 = tslib_es6_js.__asyncValues(steps), steps_2_1; steps_2_1 = yield steps_2.next(), !steps_2_1.done;) {
    ...
    createRole({ roleName, namespace, data, returnSteps, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var steps_3 = tslib_es6_js.__asyncValues(steps), steps_3_1; steps_3_1 = yield steps_3.next(), !steps_3_1.done;) {
    ...
    changeOrgOwnership({ namespace, newOwner, returnSteps = false, withSubdomains = false, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const orgNamespaces = [
                `${exports.NamespaceType.Role}.${namespace}`,
                `${exports.NamespaceType.Application}.${namespace}`,
                namespace,
            ];
            ...
            if (apps && apps.length > 0) {
                if (!withSubdomains) {
                    ...
                    try {
                        for (var apps_1 = tslib_es6_js.__asyncValues(apps), apps_1_1; apps_1_1 = yield apps_1.next(), !apps_1_1.done;) {
            ...
            const steps = changeOwnerNamespaces.map((nmspace) => {
                ...
                return {
                    tx,
                    next: ({ retryCheck } = {}) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
                        if (retryCheck) {
            ...
            try {
                for (var steps_4 = tslib_es6_js.__asyncValues(steps), steps_4_1; steps_4_1 = yield steps_4.next(), !steps_4_1.done;) {
    ...
    changeAppOwnership({ namespace, newOwner, returnSteps, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const roles = yield this.getRolesByNamespace({
                namespace,
                parentType: exports.NamespaceType.Application,
            });
            const appNamespaces = [
            ...
            try {
                for (var steps_5 = tslib_es6_js.__asyncValues(steps), steps_5_1; steps_5_1 = yield steps_5.next(), !steps_5_1.done;) {
    ...
    changeRoleOwnership({ namespace, newOwner, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const notOwnedNamespaces = yield this.validateOwnership({
                namespace,
                type: exports.NamespaceType.Role,
            });
            if (notOwnedNamespaces.length > 0) {
                throw new ChangeOwnershipNotPossibleError({
                    namespace,
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const apps = this._cacheClient
                ...
                : yield this.getSubdomains({
                    domain: `${exports.NamespaceType.Application}.${namespace}`,
                });
            if (apps && apps.length > 0) {
                throw new Error(exports.ERROR_MESSAGES.ORG_WITH_APPS);
            }
            const roles = this._cacheClient
                ? yield this._cacheClient.getOrganizationRoles(namespace)
                : yield this.getSubdomains({
                    domain: `${exports.NamespaceType.Role}.${namespace}`,
                });
            if (roles && roles.length > 0) {
                throw new Error(exports.ERROR_MESSAGES.ORG_WITH_ROLES);
            }
            const orgNamespaces = [
                `${exports.NamespaceType.Role}.${namespace}`,
                `${exports.NamespaceType.Application}.${namespace}`,
            ...
            try {
                for (var steps_6 = tslib_es6_js.__asyncValues(steps), steps_6_1; steps_6_1 = yield steps_6.next(), !steps_6_1.done;) {
    ...
    deleteApplication({ namespace, returnSteps = false, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (roles && roles.length > 0) {
                throw new Error(exports.ERROR_MESSAGES.APP_WITH_ROLES);
            }
            const appNamespaces = [`${exports.NamespaceType.Role}.${namespace}`, namespace];
            const { alreadyFinished, namespacesToDelete, notOwnedNamespaces } = yield this.validateDeletePossibility({
                namespaces: appNamespaces,
            });
            if (notOwnedNamespaces.length > 0) {
            ...
            try {
                for (var steps_7 = tslib_es6_js.__asyncValues(steps), steps_7_1; steps_7_1 = yield steps_7.next(), !steps_7_1.done;) {
    ...
    getDefinition({ type, namespace, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (type === exports.NamespaceType.Role) {
                return this._cacheClient.getRoleDefinition(namespace);
            }
            if (type === exports.NamespaceType.Application) {
                return this._cacheClient.getAppDefinition(namespace);
            }
            if (type === exports.NamespaceType.Organization) {
    ...
    getRolesByNamespace({ parentType, namespace, }) {
        if (parentType === exports.NamespaceType.Organization) {
            return this._cacheClient.getOrganizationRoles(namespace);
        }
        if (parentType === exports.NamespaceType.Application) {
    ...
    checkExistenceOfDomain({ domain, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const [exists, isOwned] = yield Promise.all([
                ...
                (() => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
    ...
    updateLegacyDefinition(domain, data) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (currentResolverAddress !== ensResolverV2Address) {
                ...
                const updateDomain = credentialGovernance.DomainReader.isRoleDefinition(data)
    ...
    registrationTypesOfRoles(roles) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (roles_1 = tslib_es6_js.__asyncValues(roles); roles_1_1 = yield roles_1.next(), !roles_1_1.done;) {
                    const role = roles_1_1.value;
                    const def = yield this.getDefinition({
                        type: exports.NamespaceType.Role,
                        namespace: role,
                    });
                    if (!credentialGovernance.DomainReader.isRoleDefinition(def)) {
                        continue;
                    }
                    ...
                    if ([this._ensResolverAddress, this._ensResolverV2Address].includes(resolver)) {
                        types[role].add(exports.RegistrationTypes.OnChain);
                        types[role].add(exports.RegistrationTypes.OffChain);
                    }
    ...
    namespacesWithRelations(namespaces) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            return Promise.all(namespaces.map((namespace) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
    ...
    nonOwnedNodesOf({ namespace, type, owner, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (![
                exports.NamespaceType.Role,
                exports.NamespaceType.Application,
                exports.NamespaceType.Organization,
            ].includes(type)) {
                throw new Error(exports.ERROR_MESSAGES.ENS_TYPE_NOT_SUPPORTED);
            }
            const namespacesToCheck = type === exports.NamespaceType.Role
                ? [namespace]
                : type === exports.NamespaceType.Application
                    ? [namespace, exports.NamespaceType.Application]
                    : [namespace, exports.NamespaceType.Application, exports.NamespaceType.Organization];
...
class IdentityManager__factory extends ethers.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
class OfferableIdentity__factory extends ethers.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
class AssetsService {
    ...
    registerAsset() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            let asset = yield this.getAssetById({
                id: `did:${did.Methods.Erc1056}:${this._signerService.chainName()}:${identity}`,
            });
            let loops = 0;
            /*
    ...
    offerAsset({ assetDID, offerTo }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const assetContractAddress = didEthrResolver.addressOf(assetDID);
     ...
     */
    getAssetHistory(_a) {
        var { id } = _a, query = tslib_es6_js.__rest(_a, ["id"]);
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
...
exports.AssetHistoryEventType = void 0;
...
})(exports.AssetHistoryEventType || (exports.AssetHistoryEventType = {}));
...
class ClaimManager__factory extends ethers.ContractFactory {
    constructor(...args) {
        if (args.length === 1) {
...
const { id, keccak256, defaultAbiCoder, solidityKeccak256, namehash, arrayify, } = ethers.utils;
/**
...
class ClaimsService {
    ...
    init() {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (signer instanceof ethers.Wallet &&
                ...
                ewSigner = didEthrResolver.EwSigner.fromPrivateKey(signer.privateKey, {
                    type: didResolverInterface.ProviderTypes.HTTP,
                    uriOrInfo: provider.connection.url,
                });
            }
            else if (provider instanceof ethers.providers.JsonRpcProvider) {
                ewSigner = didEthrResolver.EwSigner.fromEthersSigner(signer, publicKey);
            }
            else {
                /** @todo from EIP1193Provider */
                throw new Error(exports.ERROR_MESSAGES.UNKNOWN_PROVIDER);
            }
            this._claimRevocation = new onchainClaims.ClaimRevocation(ewSigner, chainConfigs()[chainId].claimsRevocationRegistryAddress);
        });
    }
    /**
     ...
     */
    createClaimRequest({ claim, subject = this._signerService.did, registrationTypes = [exports.RegistrationTypes.OffChain], }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const issuer = [
                `did:${did.Methods.Erc1056}:${this._signerService.chainName()}:${emptyAddress}`,
            ];
            const message = {
                id: uuid.v4(),
                token,
            ...
            if (registrationTypes.includes(exports.RegistrationTypes.OnChain)) {
                if (!version) {
                    throw new Error(exports.ERROR_MESSAGES.ONCHAIN_ROLE_VERSION_NOT_SPECIFIED);
                }
    ...
    issueClaimRequest({ requester, token, id: requestId, subjectAgreement, registrationTypes, issuerFields, publishOnChain = true, credentialStatusOverride, expirationTimestamp, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (registrationTypes.includes(exports.RegistrationTypes.OnChain)) {
                ...
                if (publishOnChain) {
                    if (!subjectAgreement) {
                        throw new Error(exports.ERROR_MESSAGES.ONCHAIN_ROLE_SUBJECT_AGREEMENT_NOT_SPECIFIED);
                    }
            ...
            if (registrationTypes.includes(exports.RegistrationTypes.OffChain)) {
    ...
    registerOnchain(claim) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!readyToBeRegisteredOnchain(claim)) {
                throw new Error(exports.ERROR_MESSAGES.CLAIM_WAS_NOT_ISSUED);
            }
            ...
            const data = this._claimManagerInterface.encodeFunctionData('register', [
                didEthrResolver.addressOf(subject),
                namehash(claimType),
                claimTypeVersion,
                expiry,
                didEthrResolver.addressOf(acceptedBy),
                subjectAgreement,
                onChainProof,
            ]);
     ...
     */
    issueClaim({ subject, registrationTypes = [exports.RegistrationTypes.OffChain], claim, credentialStatusOverride, expirationTimestamp, }) {
        var _a;
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const roleDefinition = yield this._domainsService.getDefinition({
                type: exports.NamespaceType.Role,
    ...
    registrationTypes = [exports.RegistrationTypes.OffChain], claim, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (registrationTypes.includes(exports.RegistrationTypes.OnChain)) {
                if (!claim.claimType) {
                    throw new Error(exports.ERROR_MESSAGES.CLAIM_TYPE_MISSING);
                }
                ...
                if (!claimDataForClaimType) {
                    throw new Error(exports.ERROR_MESSAGES.PUBLISH_NOT_ISSUED_CLAIM);
                }
            ...
            if (registrationTypes.includes(exports.RegistrationTypes.OffChain)) {
                if (!claim.token) {
                    throw new Error(exports.ERROR_MESSAGES.CLAIM_DOES_NOT_CONTAIN_TOKEN);
                }
                if (!this._didRegistry.isClaim(payload)) {
                    throw new Error(exports.ERROR_MESSAGES.CLAIM_TOKEN_DATA_MISSING);
                }
                ...
                const data = {
                    type: didResolverInterface.DIDAttribute.ServicePoint,
                    value: {
                        id: yield this.getClaimId({ claimData: claimData }),
                        serviceEndpoint: url,
                        hash: claims.hashes.SHA256(claimToken),
                        hashAlg: 'SHA256',
                    },
                };
                const isDocUpdated = yield this._didRegistry.updateDocument({
                    didAttribute: didResolverInterface.DIDAttribute.ServicePoint,
                    data,
                    did: sub,
                });
                if (!isDocUpdated) {
                    throw new Error(exports.ERROR_MESSAGES.DID_DOCUMENT_NOT_UPDATED);
                }
            }
            return url;
        });
    ...
    getUserClaims({ did = this._signerService.did, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const issuedClaimsTypes = issuedClaims
                .filter((c) => c.registrationTypes.includes(exports.RegistrationTypes.OffChain))
     ...
     */
    createDelegateProof(delegateKey, identity, algorithm = jwt.Algorithms.EIP191) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const provider = this._signerService.provider;
            ...
            if (algorithm === jwt.Algorithms.EIP191) {
                return new jwt.JWT(new ethers.Wallet(delegateKey)).sign(payload, {
                    issuer: identity,
                });
            }
            else if (algorithm === jwt.Algorithms.ES256) {
                /** @todo move to @ew-did-registry/jwt */
                return jsonwebtoken.sign(payload, keys.privToPem(delegateKey, keys.KeyType.Secp256r1), {
                    issuer: identity,
                });
            }
            else {
                throw new Error(exports.ERROR_MESSAGES.JWT_ALGORITHM_NOT_SUPPORTED);
            }
        });
    }
    /**
    ...
    revokeMultipleClaim({ claimIds, claims, }) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (!claimIds && !claims) {
                throw new Error(exports.ERROR_MESSAGES.REVOKE_CLAIM_MISSING_PARAMETERS);
            }
            const revoker = this._signerService.did;
            ...
            if (claimIds) {
                const claimsDetails = yield Promise.all([
                    ...claimIds.map((claimId) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
    ...
    getRevocationClaimDetails({ claimId, claim, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (claimId) {
                ...
                if (!claimData) {
                    throw new Error(exports.ERROR_MESSAGES.REVOKE_CLAIM_NOT_FOUND);
                }
                namespace = claimData.claimType;
    ...
    stripClaimData(data) {
        ...
        const claimData = tslib_es6_js.__rest(data, ["fields"]);
        return claimData;
    }
    /**
    ...
    validatePublishPublicClaimRequest(registrationTypes, claim) {
        if (registrationTypes.includes(exports.RegistrationTypes.OnChain) &&
            !claim.claimType) {
            throw new Error(exports.ERROR_MESSAGES.CLAIM_TYPE_REQUIRED_FOR_ON_CHAIN_REGISTRATION);
        }
        if (registrationTypes.includes(exports.RegistrationTypes.OffChain) &&
            !claim.token) {
            throw new Error(exports.ERROR_MESSAGES.TOKEN_REQUIRED_FOR_OFF_CHAIN_REGISTRATION);
        }
    }
    /**
    ...
    verifyEnrolmentPrerequisites({ subject, role, roleDefinition: cachedRoleDefinition, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!roleDefinition) {
                throw new Error(exports.ERROR_MESSAGES.ROLE_NOT_EXISTS);
            }
            ...
            const requiredRoles = enrolmentPreconditions
                .filter(({ type }) => type === credentialGovernance.PreconditionType.Role)
                .map(({ conditions }) => conditions)
                .reduce((all, cur) => all.concat(cur), []);
            yield Promise.all(requiredRoles.map((requiredRole) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
                const verificationResult = yield this.resolveCredentialAndVerify(subject, requiredRole);
                if (!verificationResult.isVerified) {
                    throw new Error(exports.ERROR_MESSAGES.ROLE_PREREQUISITES_NOT_MET);
                }
            })));
        });
    }
    ...
    approveRolePublishing({ subject, role, version, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const agreementHash = solidityKeccak256(['bytes', 'bytes32', 'bytes32'], [
                messageId,
                domainSeparator,
                keccak256(defaultAbiCoder.encode(['bytes32', 'address', 'bytes32', 'uint256'], [agreement_type_hash, didEthrResolver.addressOf(subject), namehash(role), version])),
            ]);
    ...
    createOnChainProof(role, version, expiry, subject) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            const messageId = Buffer.from(typedMsgPrefix, 'hex');
            const chainId = this._signerService.chainId;
            const domainSeparator = ethers.utils.keccak256(defaultAbiCoder.encode(['bytes32', 'bytes32', 'bytes32', 'uint256', 'address'], [
                erc712_type_hash,
                ethers.utils.id('Claim Manager'),
                ethers.utils.id('1.0'),
                chainId,
                this._claimManager,
            ]));
            const proofHash = solidityKeccak256(['bytes', 'bytes32', 'bytes32'], [
                messageId,
                domainSeparator,
                ethers.utils.keccak256(defaultAbiCoder.encode(['bytes32', 'address', 'bytes32', 'uint', 'uint', 'address'], [
                    proof_type_hash,
                    didEthrResolver.addressOf(subject),
                    namehash(role),
                    version,
    ...
    verifyVc(vc) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!issuerDID) {
                throw new Error(exports.ERROR_MESSAGES.NO_ISSUER_SPECIFIED);
            }
            let proofVerified;
            ...
            if (!proofVerified) {
                errors.push(exports.ERROR_MESSAGES.PROOF_NOT_VERIFIED);
            }
    ...
    verifyRoleEIP191JWT(roleEIP191JWT) {
        ...
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (isExpired) {
                errors.push(exports.ERROR_MESSAGES.CREDENTIAL_EXPIRED);
            }
    ...
    resolveCredentialAndVerify(subjectDID, roleNamespace) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!resolvedCredential) {
                return {
                    isVerified: false,
                    errors: [exports.ERROR_MESSAGES.NO_CLAIM_RESOLVED],
                };
            }
            return vcVerification.isEIP191Jwt(resolvedCredential)
     ...
     */
    _setIssuerVerifier() {
        this._credentialResolver = new vcVerification.IpfsCredentialResolver(this._signerService.provider, this._didRegistry.registrySettings, this._didRegistry.ipfsStore);
        const domainReader = this._domainsService.domainReader;
        this._issuerResolver = new vcVerification.EthersProviderIssuerResolver(domainReader);
        const revokerResolver = new vcVerification.EthersProviderRevokerResolver(domainReader);
        const verifyProof = (vc, proofOptions) => this._verifiableCredentialService.verify(JSON.parse(vc), JSON.parse(proofOptions));
        const revocationVerification = new vcVerification.RevocationVerification(revokerResolver, this._issuerResolver, this._credentialResolver, verifyProof);
        this._issuerVerification = new vcVerification.IssuerVerification(this._issuerResolver, this._credentialResolver, this._signerService.provider, this._didRegistry.registrySettings, revocationVerification, verifyProof);
    }
    _setStatusVerifier() {
        this._statusVerifier = new revocation.StatusListEntryVerification((vc) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            try {
...
function isRoleCredential(credential) {
    ...
    return (lodash.has(credentialSubject, 'id') &&
        lodash.has(credentialSubject, 'role') &&
        lodash.has(credentialSubject, 'issuerFields'));
}
...
class VerifiableCredentialsServiceBase {
    ...
    initiateExchange({ type, url, }) {
        var _a;
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            if (type !== credentialsInterface.VC_API_EXCHANGE) {
            ...
            const credentialQuery = (_a = vpRequest.query.find((q) => q.type === credentialsInterface.VpRequestQueryType.presentationDefinition)) === null || _a === void 0 ? void 0 : _a.credentialQuery;
            const selections = yield Promise.all(credentialQuery.map(({ presentationDefinition }) => tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
    ...
    continueExchange({ vpRequest: { challenge, interact: { service }, }, credentials, }) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            if (errors.length > 0) {
                ...
                throw new Error(exports.ERROR_MESSAGES.ERROR_CONTINUING_EXCHANGE);
            }
            if (nextVpRequest) {
    ...
    createPresentation(verifiableCredential, options) {
        const did = this._signerService.didHex;
        const pex$1 = new pex.PEX();
        if (options === null || options === void 0 ? void 0 : options.presentationDefinition) {
            return Object.assign(Object.assign({}, pex$1.presentationFrom(options.presentationDefinition, verifiableCredential, did)), { id: 'urn:uuid:' + uuid.v4() });
        }
        return {
    ...
    verify(vcOrVp, options) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            let verifyFunc;
            if (vcOrVp.type.includes(credentialsInterface.CredentialType.VerifiablePresentation)) {
                verifyFunc = this.verifyPresentation;
            }
            else if (vcOrVp.type.includes(credentialsInterface.CredentialType.VerifiableCredential)) {
            ...
            if (vcOrVp.type.includes(credentialsInterface.CredentialType.VerifiableCredential) &&
    ...
    getCredentialsByDefinition(presentationDefinition) {
        return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
            ...
            const pex$1 = new pex.PEX();
            return pex$1.selectFrom(presentationDefinition, vc);
        });
    }
    /**
...
const getVerifiableCredentialsService = (signerService, cacheClient) => tslib_es6_js.__awaiter(void 0, void 0, void 0, function* () {
    let service;
    if (executionEnvironment() === exports.ExecutionEnvironment.NODE) {
        service = yield Promise.resolve().then(function () { return require('./verifiable-credentials-node.service-889394d0.js'); }).then((module) => module.VerifiableCredentialsServiceNode.create(signerService, cacheClient));
    }
    else {
        service = yield Promise.resolve().then(function () { return require('./verifiable-credentials-web.service-468516dc.js'); }).then((module) => module.VerifiableCredentialsServiceWeb.create(signerService, cacheClient));
    }
    return service;
});
...
function initWithEKC(proxyUrl = defaultAzureProxyUrl) {
    return tslib_es6_js.__awaiter(this, void 0, void 0, function* () {
        const signerService = new SignerService(yield EkcSigner.create(proxyUrl), exports.ProviderType.EKC);
        yield signerService.init();
        return init(signerService);
    });
}
...
Object.defineProperty(exports, 'PreconditionType', {
    enumerable: true,
    get: function () { return credentialGovernance.PreconditionType; }
});
Object.defineProperty(exports, 'DIDAttribute', {
    enumerable: true,
    get: function () { return didResolverInterface.DIDAttribute; }
});
Object.defineProperty(exports, 'PubKeyType', {
    enumerable: true,
    get: function () { return didResolverInterface.PubKeyType; }
});
exports.AssetNotExist = AssetNotExist;
exports.AssetsService = AssetsService;
exports.AuthService = AuthService;
exports.CacheClient = CacheClient;
exports.ChangeOwnershipNotPossibleError = ChangeOwnershipNotPossibleError;
exports.ClaimsService = ClaimsService;
exports.ConsoleLogger = ConsoleLogger;
exports.DEFAULT_AUTH_STATUS_PATH = DEFAULT_AUTH_STATUS_PATH;
exports.DeletingNamespaceNotPossibleError = DeletingNamespaceNotPossibleError;
exports.DidRegistry = DidRegistry;
exports.DomainsService = DomainsService;
exports.ENSOwnerNotValidAddressError = ENSOwnerNotValidAddressError;
exports.ENSTypeNotSupportedError = ENSTypeNotSupportedError;
exports.EkcSigner = EkcSigner;
exports.ILogger = ILogger;
exports.IS_ETH_SIGNER = IS_ETH_SIGNER;
exports.InterfaceNotSatisfied = InterfaceNotSatisfied;
exports.MalformedDIDError = MalformedDIDError;
exports.MessagingService = MessagingService;
exports.MethodNotAvailableInNodeEnvError = MethodNotAvailableInNodeEnvError;
exports.NODE_FIELDS_KEY = NODE_FIELDS_KEY;
exports.NotAuthorizedIssuer = NotAuthorizedIssuer;
exports.PUBLIC_KEY = PUBLIC_KEY;
exports.SignerService = SignerService;
exports.SiweAuthTokensClient = SiweAuthTokensClient;
exports.StakingFactoryService = StakingFactoryService;
exports.StakingPoolService = StakingPoolService;
exports.VOLTA_CHAIN_ID = VOLTA_CHAIN_ID;
exports.VerifiableCredentialsServiceBase = VerifiableCredentialsServiceBase;
exports.addSupportedDID = addSupportedDID;
exports.agreement_type_hash = agreement_type_hash;
exports.cacheConfigs = cacheConfigs;
exports.castToV2 = castToV2;
exports.chainConfigs = chainConfigs;
exports.compareDID = compareDID;
exports.createWalletConnectProvider = createWalletConnectProvider;
exports.defaultAzureProxyUrl = defaultAzureProxyUrl;
exports.defaultBridgeUrl = defaultBridgeUrl;
exports.defaultKmsServerUrl = defaultKmsServerUrl;
exports.didPattern = didPattern;
exports.emptyAddress = emptyAddress;
exports.erc712_type_hash = erc712_type_hash;
exports.eternityTimestamp = eternityTimestamp;
exports.executionEnvironment = executionEnvironment;
exports.fromGnosis = fromGnosis;
exports.fromKms = fromKms;
exports.fromMetaMask = fromMetaMask;
exports.fromPrivateKey = fromPrivateKey;
exports.fromWalletConnectMetamask = fromWalletConnectMetamask;
exports.getLogger = getLogger;
exports.getMessagingConfig = getMessagingConfig;
exports.getVerifiableCredentialsService = getVerifiableCredentialsService;
exports.init = init;
exports.initWithEKC = initWithEKC;
exports.initWithGnosis = initWithGnosis;
exports.initWithKms = initWithKms;
exports.initWithMetamask = initWithMetamask;
exports.initWithPrivateKeySigner = initWithPrivateKeySigner;
exports.initWithWalletConnect = initWithWalletConnect;
exports.isClaimService = isClaimService;
exports.isMetamaskExtensionPresent = isMetamaskExtensionPresent;
exports.isRoleCredential = isRoleCredential;
exports.isValidDID = isValidDID;
exports.proof_type_hash = proof_type_hash;
exports.readyToBeRegisteredOnchain = readyToBeRegisteredOnchain;
exports.setCacheConfig = setCacheConfig;
exports.setChainConfig = setChainConfig;
exports.setLogger = setLogger;
exports.setMessagingConfig = setMessagingConfig;
exports.statusList2021CredentialEIP712Types = statusList2021CredentialEIP712Types;
exports.supportedDIDMethods = supportedDIDMethods;
exports.typedMsgPrefix = typedMsgPrefix;
exports.validateRoleCredentialSubject = validateRoleCredentialSubject;
exports.verifiableCredentialEIP712Types = verifiableCredentialEIP712Types;
exports.verifiablePresentationEIP712Types = verifiablePresentationEIP712Types;
exports.verifiablePresentationWithCredentialEIP712Types = verifiablePresentationWithCredentialEIP712Types;
