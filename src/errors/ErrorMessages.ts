export enum ERROR_MESSAGES {
    ...
    ROLE_PREREQUISITES_REQUIRED_PARAM_INVALID = "Required Param for enrolment subject not provided",
    ROLE_REQUIRED_PARAMS_DEFINITION_INVALID = "Required params definition is not valid",
    ROLE_REQUIRED_PARAM_PATTERN_NOT_VALID_REGEX = "Required param pattern is not valid regex",
