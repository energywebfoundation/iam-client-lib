...
import { S3DidStore } from './did.store';
...
export class DidRegistry {
  ...
  async init() {
    this._didStore = new S3DidStore(this._didStoreConfig.bucketName, this._didStoreConfig.credential);
